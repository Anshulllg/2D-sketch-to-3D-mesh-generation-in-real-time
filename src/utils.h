...
void closewind(GLFWwindow* );
void ptpush(float , float, int, int);
float scaling_X(float , float, int, int);
float scaling_Y(float , float, int, int);
void trans(float[],int);
void addPoints(std::vector<float> &points, int x, int y, int w, int h);
void facebuff();
void tribuff_add();
void cpt_add(std::vector<float> &points, int x, int y, int w, int h);
